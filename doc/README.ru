...
------------------------------------------------------------------------------
	...
	Автор:	Art Mitskevich <art@unlit.org>
		Все багрепорты, фичур-реквесты(гы гы), ругательства и
		предложения слать по указанному выше адресу.
		Весь спам слать по этому адресу: bill@microsoft.com
